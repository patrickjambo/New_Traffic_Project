  ...
  const handleUseMyLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        setStart(`Current Location (${latitude.toFixed(4)}, ${longitude.toFixed(4)})`);
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="e.g., Kimihurura, Airport..."
                ...
                <div className="absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl max-h-60 overflow-y-auto">
                  {startSuggestions.map((loc, idx) => (
                    <div
                      ...
                      className="px-4 py-3 hover:bg-blue-50 cursor-pointer border-b border-gray-100 last:border-b-0 flex flex-col"
                    >
                      <span className="font-medium text-sm text-gray-800">{loc.name}</span>
                      <span className="text-xs text-gray-500">{loc.type} • {loc.district || 'Kigali'}</span>
                    </div>
                  ))}
                </div>
              )}
            ...
            >
              {loadingLocation ? <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-blue-700"></div> : <Navigation className="w-5 h-5" />}
            </button>
          </div>
        </div>
        <div className="relative">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="e.g., City Center, Nyabugogo..."
              className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50"
            />
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen relative">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl mx-auto">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 hover:bg-white/20 transition-all">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-semibold text-green-300">+12%</span>
                  </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 hover:bg-white/20 transition-all">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-semibold text-green-300">+5%</span>
                  </div>
                  <div className="text-2xl font-bold">{statistics?.active_reports || 5}</div>
                  <div className="text-xs text-blue-100">Active Reports</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 hover:bg-white/20 transition-all">
                  <div className="flex items-center justify-between mb-1">
                    <Camera className="w-5 h-5 text-green-300" />
                    <span className="text-xs font-semibold text-green-300">+28%</span>
                  </div>
                  <div className="text-2xl font-bold">{statistics?.mobile_captures || 12}</div>
                  <div className="text-xs text-blue-100">Mobile Captures</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 hover:bg-white/20 transition-all">
                  <div className="flex items-center justify-between mb-1">
                    <Clock className="w-5 h-5 text-yellow-300" />
                    <span className="text-xs font-semibold text-red-300">-15%</span>
                  </div>
                  <div className="text-2xl font-bold">{statistics?.avg_response_time || 8}min</div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <button
                  ...
                  className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 hover:shadow-md transition-all hover:-translate-y-1 group text-left"
                >
                  ...
                  <h3 className="text-lg font-bold mb-2 text-gray-900">Report Incident</h3>
                  <p className="text-sm text-gray-500">Submit a new traffic incident report</p>
                </button>

                <button
                  onClick={() => setShowEmergencyModal(true)}
                  className="bg-gradient-to-br from-red-50 to-orange-50 border border-red-100 rounded-xl shadow-sm p-6 hover:shadow-md transition-all hover:-translate-y-1 group text-left"
                >
                  ...
                  <h3 className="text-lg font-bold mb-2 text-red-900">Emergency</h3>
                  <p className="text-sm text-red-700">Report critical emergency situations immediately</p>
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li><button onClick={() => setShowIncidentModal(true)} className="hover:text-white">Report Incident</button></li>
      ...
      >
        <ReportIncidentForm onSuccess={() => setShowIncidentModal(false)} />
      </Modal>
