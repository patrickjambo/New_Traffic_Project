            ...
            {incidents.map((incident, idx) => (
              <div 
                ...
                className={`p-3 rounded border-l-4 cursor-pointer transition-all hover:shadow-md ${
                  selectedIncident?.id === incident.id ? 'bg-blue-100 border-blue-600' :
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-16 overflow-hidden">
        {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Report Incident & Emergency Forms */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link
            to="/incidents"
            className="bg-gradient-to-br from-red-500 to-red-600 text-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all hover:scale-105 block"
          >
          ...
          <Link
            to="/report"
            className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all hover:scale-105 block"
          >
            <Activity className="w-8 h-8 mb-3" />
            <h3 className="text-lg font-bold mb-2">Report Incident</h3>
            <p className="text-sm text-blue-100">Submit traffic incident reports</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-orange-100">Report critical emergency situations</p>
          </button>
        </div>
      </div>
